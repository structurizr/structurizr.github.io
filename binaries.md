...
- Tags:
  - `2026.05.16` and `latest`: [Hardened Eclipse Temurin 21 - Alpine](https://hub.docker.com/hardened-images/catalog/dhi/eclipse-temurin) base image for general production use.
  - `2026.05.16-playwright`: Non-hardened [Playwright for Java - Noble](https://mcr.microsoft.com/en-us/artifact/mar/playwright/java) base image that includes the Microsoft Playwright dependencies required to use the PNG/SVG export feature.
...
- Requires Java 21
- Downloads:
  - [structurizr-2026.05.16.war](https://download.structurizr.com/structurizr-2026.05.16.war) and [structurizr.war](https://download.structurizr.com/structurizr.war): Excludes Microsoft Playwright dependencies.
  - [structurizr-2026.05.16-playwright.war](https://download.structurizr.com/structurizr-2026.05.16-playwright.war): Includes Microsoft Playwright dependencies.
