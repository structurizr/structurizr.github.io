...
- Tags:
  - `2026.05.22` and `latest`: [Hardened Eclipse Temurin 21 - Alpine](https://hub.docker.com/hardened-images/catalog/dhi/eclipse-temurin) base image for production use.
  - `2026.05.22-noble`: [Non-hardened Eclipse Temurin 21 - Noble](https://hub.docker.com/_/eclipse-temurin) base image for general use, including CI environments.
  - `2026.05.22-playwright`: Non-hardened [Playwright for Java - Noble](https://mcr.microsoft.com/en-us/artifact/mar/playwright/java) base image that includes the Microsoft Playwright dependencies required to use the PNG/SVG export feature.
...
- Requires Java 21
- Downloads:
  - [structurizr-2026.05.22.war](https://download.structurizr.com/structurizr-2026.05.22.war) and [structurizr.war](https://download.structurizr.com/structurizr.war): Excludes Microsoft Playwright dependencies.
  - [structurizr-2026.05.22-playwright.war](https://download.structurizr.com/structurizr-2026.05.22-playwright.war): Includes Microsoft Playwright dependencies.
