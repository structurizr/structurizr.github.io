...
| [Sharing link](https://structurizr.com/help/workspace-sharing)<br />Share your workspace using a read-only URL.                                                                                       |                           | Yes                       |              | Yes               |
| [Role-based access](https://structurizr.com/help/workspace-security)<br />Share your workspace with team members, using role-based security.                                                          |                           | Yes                       |              | Yes               |
| [Restrict access by IP address](https://structurizr.com/help/ip-address-restrictions)<br />Configure allowed IP addresses for extra security.                                                         |                           |                           |              | Yes               |
| [Client-side encryption](https://structurizr.com/help/client-side-encryption)<br />Encrypt workspaces before uploading via the cloud API, and decrypt them in your browser using your own passphrase. |                           | Yes                       |              | Yes               |
| [Workspace locking](https://structurizr.com/help/workspace-locking)<br />Workspace locking to avoid concurrent updates.                                                                               |                           | Yes                       |              | Yes               |
| [Workspace versioning](https://structurizr.com/help/workspace-versioning)<br />Recent versions of your workspace are retained.                                                                        |                           | Yes                       |              | Yes               |
...
| [Diagram export](https://structurizr.com/help/exporting-diagrams)<br />Export diagrams (and their key/legend) to PNG and SVG files.                                                                   | Yes                       | Yes                       | Yes          | Yes               |
| [Documentation export](https://structurizr.com/help/exporting-documentation)<br />Export documentation to a single HTML page.                                                                         | Yes                       | Yes                       | Yes          | Yes               |
...
| [Notion](https://structurizr.com/help/notion)<br />Embed live architecture diagrams into Notion pages via an iframe.                                                                                  |                           |                           |              | Yes               |
| [Slack](https://structurizr.com/help/slack)<br />Perform a full-text search across a workspace using a slash command.                                                                                 |                           |                           |              | Yes               |              
| [Authentication via LDAP or SAML 2.0](https://docs.structurizr.com/onpremises/authentication)<br />Integrate Structurizr with your identity provider.                                                 |                           | Yes                       |              |                   |
