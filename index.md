...
| [Notion](/cloud/notion)<br />Embed live architecture diagrams into Notion pages via an iframe.                                                                                                        |                           |                                  |                             | Yes                          |
| [Slack](/cloud/slack)<br />Perform a full-text search across a workspace using a slash command.                                                                                                       |                           |                                  |                             | Yes                          |              
