...
1. Don't model every software system in a single workspace - see [enterprise usage pattern](/workspaces/enterprise) for an approach to model a landscape of connected software systems across multiple workspaces.
