...
|----------------------------------------|--------------------------------------------------------|
| [server](/server)                      | Strict or relaxed, based upon configuration            |
| [local](/local)                        | Strict or relaxed, based upon the workspace scope      |
| `push`, `pull`, `export`, etc commands | Strict or relaxed, based upon the workspace scope      |
...
1. Ask your installation administrator to [enable unscoped workspaces](/server/configuration#workspace-scope) (set `structurizr.feature.workspace.scope` to `relaxed`) or
2. [Set the workspace scope](#setting-the-workspace-scope) to "software system" or "landscape" in your workspace (you may need to modify your workspace content to meet the [validation rules](#validation)).